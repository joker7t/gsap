            ...
            <div className="navigation">
                ...
                <nav className="navigation__nav">
                    <ul className="navigation__list">
                        <li className=""><a href="#" className="navigation__link"><span>01</span>About Natous</a></li>
                        <li className=""><a href="#" className="navigation__link"><span>02</span>Your benfits</a></li>
                    ...
                    <picture className="footer__logo">
                        {
                            ...
                            // <img srcset="img/logo-green-1x.png 1x, img/logo-green-2x.png 2x" alt="Full logo" src={logogreen2x} />

                        }
                        <img alt="Full logo" src={logogreen2x} />
                    </picture>
                </div>
                <div className="row">
                    <div className="col-1-of-2">
